; ---------------------------------------------------------------------------
; Music (Title)Bar CDL install script for NSIS
; ---------------------------------------------------------------------------

;These defines are all you need to change to make a basic Installer for your CDL Plugin
!define NAME "Music (Title)Bar for TCMP v0.0.4" 									; This is the name of your App/Plugin
!define OUTFILE "Release_TCMP\MusicTitleBar_TCMP.exe" 		; The filename that the installer will be write out to
!define SRC_PREFIX "Release_TCMP\"
!define CDL_FILE "MusicTitleBar_TCMP.cdl" 								;Your CDL filename
...
!define UNINST_NAME "MusicTitleBar_TCMP-uninstall.exe" 		; Name of the Uninstaller filename. Please leave the '-uninstall.exe'
...
!endif
   ...
   DeleteRegKey HKEY_CURRENT_USER "SOFTWARE\CoreCodec\The Core Media Player\Music (Title)Bar"
